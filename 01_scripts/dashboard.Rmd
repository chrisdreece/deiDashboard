...
Pyramid Constraints {data-height=600}
-----------------------------------------------------------------------
...
Female Promotion Rate {data-height=600}
-----------------------------------------------------------------------
...
Female New Hire Rate {data-height=600}
-----------------------------------------------------------------------
...
diversity2<-reactive(diversity() %>%
                       ...
                       mutate(countPect=ifelse(gender=='Female' & period=='forecast' & mgr=='Staff',targetStaff,countPect)) %>%
                       mutate(countPect=ifelse(gender=='Male' & period=='forecast' & mgr=='Staff',1-targetStaff,countPect)) %>%
  group_by(mgr,period) %>%
